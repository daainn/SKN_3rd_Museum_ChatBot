...
| 이미지 url 추출 | `김수철 작품에 대해 알려줘` | `김수철은 조선말기 화가로 유명합니다. 그의 작품은 독특하고 새로운 감각을 보여줍니다. 눈 내린 누각에서 매화를 감상하는 선비라는 그림은 김수철의 특징을 잘 나타내고 있어요. 이 작품은 김수철의 창조성과 독창성을 잘 보여주는 대표작입니다.https://www.museum.go.kr/relic_image/PS0101010100/700/700/2019/1115161844148/700/52.jpg?cmd=normal&fileSequence=111 (관련 유물)`| 이미지 url을 가져오긴 하나 올바른 url을 가져오지 않는 것을 확인 |
...
- **유물 데이터 추가 확보**
  ...
  - 이를 보완하기 위해 **전국 박물관 데이터를 추가 수집**하고,  
    RAG 성능 향상을 위한 **문서 다양성과 양적 확장**을 지속적으로 추진할 예정.
<br>

- **이미지 추가 제공**
  - 현재 작품에 대한 설명과 함께 이미지 URL을 제공하고 있지만, 잘못된 주소의 URL을 불러오는 경우가 자주 발생.
  - 추후에는 이미지 URL을 페이지상으로 설명과 함께 바로 띄우는 것까지 추가할 예정
